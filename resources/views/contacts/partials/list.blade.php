                ...
                @foreach($contacts as $contact)
                  <tr>
                    ...
                    <td class="mailbox-name">
                        <small class="type-control"><i class="fa {{ $contact->present()->typeClass }}" title="{{ ucfirst($contact->type) }}"></i></small>
                        <a href="{{ route('contact.single', ['id' => $contact->id])}}">
                            {{ $contact->present()->displayName }}
                        </a>
                        @if($contact->present()->roleInCompany)
                            <div>
                                  <small class="text-muted">
                                     {{ $contact->present()->roleInCompany }}
                                  </small>
                            </div>
                         @endif
